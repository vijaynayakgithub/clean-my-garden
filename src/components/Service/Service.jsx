...
const Service = () => {
  ...
  return (
    <>
      <Header />
      <SubHeader title="Service" subtitle="Experience our dedication firsthand." />
            ...
            Array(1).fill(null).map((_item, id) => (
              <div className="col-lg-4 col-md-6 col-sm-6" key={id + 6}>
                <div className="card shadow border-0 mb-5">
                  ...
                  <div className="p-2">
                    <h4 className="mt-4 mb-2">Garden Cleaning</h4>
                    <p className="mb-4">Perform garden cleaning to your home and revamp the looks</p>
                  </div>
                </div>
              </div>
            ))
            ...
            <div className="col-lg-7">
              <div className="d-flex align-items-center">
                <div className='mb-4 section-title text-center'>
                  <h2 className='text-uppercase'>We are pleased to provide the best</h2>
                  <p className='form-text'>Book a session with us and get your garden cleaned.</p>
