                            ...
                            <div className="col-md-6">
                                <div className="invoice-info">
                                    ...
                                    <p className="invoice-details invoice-details-two">
                                        Mr. {data?.appointment?.doctor?.firstName ? `${data?.appointment?.doctor?.firstName} ${data?.appointment?.doctor?.lastName}`: ' Of Clean My Garden'} <br />
                                        {data?.appointment?.doctor?.address ? data?.appointment?.doctor?.address : "London, Europe ,UK,12435"}, {data?.appointment?.doctor?.city && data?.appointment?.doctor?.city},<br />
