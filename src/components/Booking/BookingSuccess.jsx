                        ...
                        <div className=" p-3" style={{ marginTop: '8rem', marginBottom: '5rem', height: '60vh', background: '#f8f9fa', maxWidth: '400px' }}>
                            ...
                            <div className='card border-0 p-3 rounded mb-5'>
                                <div className='d-flex gap-3 mb-2 align-items-center'>
                                    ...
                                    <Link to={`/dashboard/appointments/${id}`}><h5 className='text-primary'>View Meeting Details</h5></Link>
                                </div>
                                <div className='d-flex gap-3 mb-1'>
                                    <FaBriefcase style={{ fontSize: '1rem' }} />
                                    <p>With Clean My Garden</p>
                                </div>
                                <div className='d-flex gap-3 mb-1'>
                                ...
                                <div className='d-flex gap-3 mb-1'>
                                    ...
                                    <p className='text-start'>UK, London<br /><span className="form-text">12345 NorthEast</span></p>
                                </div>
