        ...
        <>
            <nav id="navbar" className="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li><NavLink to={'/doctors'} className={({ isActive }) => isActive ? "nav-link scrollto active" : ""}>Gardeners</NavLink></li>
            ...
            >
                <ul className="mobile-menu-nav">
                    ...
                    <li><NavLink to={'/doctors'} className={({ isActive }) => isActive ? "nav-link scrollto active" : ""}><FaUserMd className="icon" />Gardeners</NavLink></li>
