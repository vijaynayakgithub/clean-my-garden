            ...
            <div className='d-flex p-3 justify-content-between'>
                <div className='d-flex gap-3'>
                    ...
                    <div className="doc-info">
                        ...
                        <p className="doc-department m-0"><img src={showImg} className="img-fluid" alt="Speciality" />Flower Garden</p>
                ...
                <div className="doc-info-right me-3">
                    ...
                    <div className="clinic-booking">
                        ...
                        <Link to={`/booking/${data?.id}`} className="apt-btn">Book Session</Link>
                    </div>
                </div>
            </div>
        </div>
