...
const TreatmentEdit = () => {
    ...
    useMessageEffect(presIsloading, presIsSuccess, presIsError, presError, 'Successfully Updated!');
    useMessageEffect(deleteIsloading, deleteIsSuccess, deleteIsError, deleteError, 'Successfully Remedy deleted!');
    useMessageEffect(createLoading, isSuccess, isError, error, 'Successfully Remdy Added!');
    useMessageEffect(updateIsloading, updateIsSuccess, updateIsError, updateError, 'Successfully Remedy Updated!');
        ...
        <DashboardLayout>
            ...
            <div className="w-100 mb-3 rounded p-3 bg-gray-g">
                <div className="text-center mb-2 d-flex justify-content-center">
                    <h5 className="border-success border-bottom w-25 pb-2 border-5">Start Gardening</h5>
                </div>
                ...
                <form className="row form-row" onSubmit={handleSubmit(onSubmit)}>
                    <div className="col-md-6">
                        <div className="form-group mb-4">
                            <div className="mb-2">
                                <h6 className="card-title text-secondary">Change Session Status</h6>
                            </div>
                            {isReadyData &&
                                <SelectForm
                                    showSearch={true}
                    ...
                    <div className="col-md-6">
                        <div className="form-group mb-4">
                            <div className="mb-2">
                                <h6 className="card-title text-secondary">Change Customer Status</h6>
                            </div>
                            {isReadyData &&
                                <SelectForm
                                    showSearch={true}
                    ...
                    <div className="col-md-12">
                        <div className="card p-3 mb-3">
                            <h6 className="card-title text-secondary">Identify Issue & Signs</h6>
                    ...
                    <div className="col-md-12 mb-3">
                        <div className="card mb-2 p-3 mt-2">
                            <h6 className="card-title text-secondary">Issue Checkup</h6>
                            <div className="row form-row">
                                <div className="form-group mb-2 card-label">
                                    <label>Issue Checkup</label>
                                    {isReadyData &&
                                        <SelectForm
                                            mode={true}
                    ...
                    <div className="col-md-12">
                        <div className="card mb-2 p-3 mt-2">
                            <h6 className="card-title text-secondary">Issue Fix</h6>
                            {
                                isReadyData && medicineList?.map((item, index) => (
                                    <div className="row form-row mb-4 position-relative border border-success rounded m-2 p-2" key={index + 1}>
                                        ...
                                        <div className="position-absolute text-end mb-3 top-0">
                                            <Popconfirm
                                                title="Delete remedy"
                                                description="Are you sure to delete this remedy?"
                            ...
                            {addMedicine.length > 0 &&
                                <>
                                    ...
                                    <div className="text-end">
                                        <Button type="primary" icon={<FaCheck />} onClick={handleAddMedicine} disabled={addMedicine.length === 0}>Add All</Button>
                                    </div>
                                </>
                            }
